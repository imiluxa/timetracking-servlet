...
public class SecurityUtility {
    ...
    public SecurityUtility() {
        ...
        authCommands.put(Role.USER,
                new HashSet<>(Arrays.asList("/", "/index",  "/log", "/logout", "/user", "/activities", "/request", "/update_activity", "/add_activity")));
        authCommands.put(Role.ADMIN,
                new HashSet<>(Arrays.asList("/", "/index",  "/log", "/logout", "/user", "/activities", "/request", "/create_activity", "/users", "/add_activity", "/update_activity")));
